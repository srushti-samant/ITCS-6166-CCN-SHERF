...
class NeuBodyDatasetBatch(Dataset):
    def __init__(self, data_root, split='test', border=5, N_rand=1024*32, num_instance=1, 
        ...
        # Load annotations specifically for CoreView_313
        core_313_root = os.path.join(data_root, 'CoreView_313')
        ann_file = os.path.join(core_313_root, 'annots.npy')
        ...
        # Adjust image paths for CoreView_313
